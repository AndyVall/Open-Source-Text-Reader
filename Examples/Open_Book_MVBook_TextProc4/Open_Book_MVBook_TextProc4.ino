...
void loop()
{
  ...
  // allocate an appropriately sized buffer (codepoints outside the basic multilingual plane can be 
  // larger than a uint16_t, but for now Babel only supports the BMP)
